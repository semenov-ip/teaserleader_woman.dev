...
class Statistiques_frompost_countdata_country {
  ...
  function getStatistiqCount($statistiqConfig, $searchData){
    ...
    $statistiqCountRurCtr = $this->getStatistiqCountRurCtr($curentDataStatistiqArr, $statistiqConfig);
  ...
  function getStatistiqCountRurCtr($curentDataStatistiqArr, $statistiqConfig){
    if( is_array($curentDataStatistiqArr) ){

      foreach ($curentDataStatistiqArr as $key => $statistiq) {

        $statistiq['view'] = $statistiq[$statistiqConfig['view_column']];
        $statistiq['click'] = $statistiq[$statistiqConfig['click_column']];
